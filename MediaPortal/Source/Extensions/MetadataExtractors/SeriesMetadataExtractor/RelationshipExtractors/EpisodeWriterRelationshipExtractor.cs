...
{
  class EpisodeWriterRelationshipExtractor : IRelationshipRoleExtractor, ISeriesRelationshipExtractor
  {
    ...
    public EpisodeWriterRelationshipExtractor()
    {
      _includeDetails = ServiceRegistration.Get<ISettingsManager>().Load<SeriesMetadataExtractorSettings>().IncludeWriterDetails;
    }
    ...
    public bool TryExtractRelationships(IDictionary<Guid, IList<MediaItemAspect>> aspects, out ICollection<IDictionary<Guid, IList<MediaItemAspect>>> extractedLinkedAspects, bool forceQuickMode)
    {
      ...
      OnlineMatcherService.UpdateEpisodePersons(episodeInfo, PersonAspect.OCCUPATION_WRITER, forceQuickMode);
