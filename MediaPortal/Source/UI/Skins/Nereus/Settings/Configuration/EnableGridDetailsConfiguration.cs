...
{
  public class EnableGridDetailsConfiguration : YesNo, IDisposable
  {
    public EnableGridDetailsConfiguration()
    {
    ...
    {
      base.Load();
      _yes = SettingsManager.Load<NereusSkinSettings>().EnableGridDetails;
    }
    ...
    public override void Save()
    {
      ...
      settings.EnableGridDetails = _yes;
