...
namespace MediaPortal.SkinEngine.Players
{
  ...
  {
    public static void ReleaseGUIResources(IPlayer player)
    {
      ISlimDXVideoPlayer sdvp = player as ISlimDXVideoPlayer;
      if (sdvp == null)
        return;
      sdvp.ReleaseGUIResources();
    }

    public static void ReallocGUIResources(IPlayer player)
    {
      ISlimDXVideoPlayer sdvp = player as ISlimDXVideoPlayer;
      if (sdvp == null)
        return;
