...
namespace MediaPortal.Presentation.Models
{
  ...
  /// This class provides initialization and disposal methods for the timer and for system message queue registrations.
  /// </summary>
  public abstract class BaseTimerControlledUIModel : IDisposable
  {
