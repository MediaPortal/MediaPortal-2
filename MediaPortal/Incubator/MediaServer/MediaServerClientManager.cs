...
namespace MediaPortal.Extensions.MediaServer
{
  ...
  {
    public void AttachClient(Guid clientId)
    {
      ClientManagerMessaging.SendClientAttachmentChangeMessage(ClientManagerMessaging.MessageType.ClientAttached, clientId.ToString());
    }
