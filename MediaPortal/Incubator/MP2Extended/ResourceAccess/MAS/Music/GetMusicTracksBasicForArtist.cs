...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Music
{
  ...
  {
    public static Task<IList<WebMusicTrackBasic>> ProcessAsync(RequestContext context, string id, string filter, WebSortField? sort, WebSortOrder? order)
    {
      if (id == null)
        throw new BadRequestException("GetMusicTracksBasicForArtist: id is null");
      ...
      if (tracks.Count == 0)
        return Task.FromResult<IList<WebMusicTrackBasic>>(new List<WebMusicTrackBasic>());
