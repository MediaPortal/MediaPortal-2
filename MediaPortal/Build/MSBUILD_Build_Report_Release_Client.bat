...
..\Tools\BuildReport\bin\Release\BuildReport.exe /Input=MSBUILD_Build_Report_Release_x86.txt /Output=MSBUILD_Build_Report_Release_x86.html /Solution=MP2-Client.sln /Title="MediaPortal 2 Client - Build Report"