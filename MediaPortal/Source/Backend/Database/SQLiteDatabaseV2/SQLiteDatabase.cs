  ...
  public class SQLiteDatabase : ISQLDatabasePaging, IDisposable
  {
    ...
    public SQLiteDatabase()
    {
      ...
      try
      {
        ...
        //};
        var connBuilder = new SqliteConnectionStringBuilder();
        connBuilder.DataSource = databaseUri;
    ...
    internal SqliteConnection CreateOpenAndInitializeConnection()
    {
      ...
      using (var command = new SqliteCommand("PRAGMA binaryguid=True;PRAGMA cache_size=65536;PRAGMA journal_mode=Wal;PRAGMA synchronous=Normal;PRAGMA foreign_keys=True;PRAGMA wal_autocheckpoint=32768;PRAGMA temp_store=MEMORY;", connection))
        command.ExecuteNonQuery();
