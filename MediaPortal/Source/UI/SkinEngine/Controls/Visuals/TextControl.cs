...
namespace MediaPortal.UI.SkinEngine.Controls.Visuals
{
  ...
  public class TextControl : Control
  {
    ...
    protected RawRectangleF _cursorBounds;
    ...
    public override void RenderOverride(RenderContext localRenderContext)
    {
      ...
      if ((_cursorShapeInvalid || _cursorBrushInvalid) && CursorState == TextCursorState.Visible)
      {
        ...
        _cursorBounds = new RawRectangleF(_innerRect.Left + _virtualPosition + caretX, _innerRect.Top + textInsetY, CURSOR_THICKNESS, textHeight);
