...
{
  [DebuggerDisplay("CopyFile({Source}->{Target}, Overwrite={Overwrite})")]
  partial class CopyFileActionModel
  {
    ...
    public override void Execute(InstallContext context)
    {
      ...
      Package.EnsureFileExtracted(sourcePath);
      FileHelper.CopyFile(context,
        sourcePath, 
