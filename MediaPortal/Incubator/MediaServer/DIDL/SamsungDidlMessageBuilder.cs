      ...
      if (!_hasCompleted)
      {
        ...
        if (directoryPropertyObject is MediaLibraryVideoItem)
        {
          try
          {
            ...
            {
              oValue = res.Item.Aspects[ImporterAspect.ASPECT_ID].GetAttributeValue(ImporterAspect.ATTR_DATEADDED);
            }
            ...
            oValue = res.Item.Aspects[VideoAspect.ASPECT_ID].GetAttributeValue(VideoAspect.ATTR_WIDTH);
            if (oValue != null)
            {
              dcm += ",WIDTH=" + Convert.ToString(oValue);
            }
            oValue = res.Item.Aspects[VideoAspect.ASPECT_ID].GetAttributeValue(VideoAspect.ATTR_HEIGHT);
            if (oValue != null)
            {
              dcm += ",HEIGHT=" + Convert.ToString(oValue);
            }
            oValue = res.Item.Aspects[MediaAspect.ASPECT_ID].GetAttributeValue(MediaAspect.ATTR_RECORDINGTIME);
            if (oValue != null)
            {
        ...
        else if (directoryPropertyObject is MediaLibraryImageItem)
        {
          try
          {
            ...
            object oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_MAKE);
            if (oValue != null)
            {
            ...
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_MODEL);
            if (oValue != null)
            {
            ...
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_FNUMBER);
            if (oValue != null)
            {
            ...
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_ISO_SPEED);
            if (oValue != null)
            {
            ...
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_EXPOSURE_TIME);
            if (oValue != null)
            {
            ...
            string dcm = "CREATIONDATE=" + lCreationDate;
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_WIDTH);
            if (oValue != null)
            {
              dcm += ",WIDTH=" + Convert.ToString(oValue);
            }
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_HEIGHT);
            if (oValue != null)
            {
              dcm += ",HEIGHT=" + Convert.ToString(oValue);
            }
            oValue = res.Item.Aspects[ImageAspect.ASPECT_ID].GetAttributeValue(ImageAspect.ATTR_ORIENTATION);
            if (oValue != null)
            {
