...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.TvShow
{
  ...
  internal class GetTVSeasonDetailedById : BaseTvSeasonDetailed
  {
    public static Task<WebTVSeasonDetailed> ProcessAsync(RequestContext context, string id)
    {
      ...
      return Task.FromResult(TVSeasonDetailed(context, item, null));
    }
