...
{
  public class ServerFanArtMaxBackdrops : LimitedNumberSelect, IDisposable
  {
    public ServerFanArtMaxBackdrops()
    {
      Enabled = false;
    ...
    public override async Task Load()
    {
      ...
      _value = (await serverSettings.LoadAsync<FanArtSettings>()).MaxBackdropFanArt;
    }
    ...
    public override async Task Save()
    {
      ...
      settings.MaxBackdropFanArt = Convert.ToInt32(_value);
