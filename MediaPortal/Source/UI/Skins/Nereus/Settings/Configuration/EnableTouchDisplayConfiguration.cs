...
{
  public class EnableTouchDisplayConfiguration : YesNo, IDisposable
  {
    public EnableTouchDisplayConfiguration()
    {
    ...
    {
      base.Load();
      _yes = SettingsManager.Load<NereusSkinSettings>().EnableTouchDisplay;
    }
    ...
    public override void Save()
    {
      ...
      settings.EnableTouchDisplay = _yes;
