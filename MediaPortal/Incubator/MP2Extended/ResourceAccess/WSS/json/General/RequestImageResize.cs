...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.WSS.json.General
{
  ...
  internal class RequestImageResize : BaseGetArtwork
  {
    public static Task<WebBoolResult> ProcessAsync(RequestContext context, WebMediaType mediatype, int? provider, string id, WebFileType artworktype, int offset, int maxWidth, int maxHeight, string borders = null, string format = null)
    {
      int offsetInt = 0;
