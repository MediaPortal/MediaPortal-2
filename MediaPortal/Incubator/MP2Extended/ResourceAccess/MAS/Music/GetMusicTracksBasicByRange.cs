...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Music
{
  ...
  {
    public static async Task<IList<WebMusicTrackBasic>> ProcessAsync(RequestContext context, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
