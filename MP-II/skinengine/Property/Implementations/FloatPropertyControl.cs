...
{
  public class FloatPropertyControl : IFloatProperty
  {
    private IFloatProperty _property;
    private string _controlName;
    private Control _control;

    public FloatPropertyControl(IFloatProperty property, string controlName)
    {
      _property = property;
