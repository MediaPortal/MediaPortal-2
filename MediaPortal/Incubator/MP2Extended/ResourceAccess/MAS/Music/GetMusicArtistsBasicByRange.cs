...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Music
{
  ...
  {
    public static async Task<IList<WebMusicArtistBasic>> ProcessAsync(HttpContext context, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
