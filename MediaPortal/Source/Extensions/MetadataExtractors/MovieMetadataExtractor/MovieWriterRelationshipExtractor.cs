...
namespace MediaPortal.Extensions.MetadataExtractors.MovieMetadataExtractor
{
  ...
  {
    private static readonly Guid[] ROLE_ASPECTS = { VideoAspect.ASPECT_ID, MovieAspect.ASPECT_ID };
    ...
    public bool TryExtractRelationships(IDictionary<Guid, IList<MediaItemAspect>> aspects, out ICollection<IDictionary<Guid, IList<MediaItemAspect>>> extractedLinkedAspects, bool forceQuickMode)
    {
      ...
      MovieInfo movieInfo;
      if (!MovieRelationshipExtractor.GetBaseInfo(aspects, out movieInfo))
        return false;

      MovieTheMovieDbMatcher.Instance.UpdateMoviePersons(movieInfo, persons, PersonOccupation.Writer);
      MovieOmDbMatcher.Instance.UpdateMoviePersons(movieInfo, persons, PersonOccupation.Writer);
