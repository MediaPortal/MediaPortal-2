...
namespace SkinEngine.Players
{
  public class OsdProperties
  {
    ...
    public OsdProperties(MediaPlayers players)
    {
      ...
      _players = players;
      _topBarVisible = new Property("Players.TopBarVisible", false);
      _currentTime = new Property("");
      _remainingTime = new Property("");
      _duration = new Property("");
      _percentPlayed = new Property(0);
      _pipUsed = new Property(false);
      _volume = new Property((int)100);
      _title = new Property("");
      _zoomMode = new Property("");
      _croppingTopLeft = new Property("");
      _croppingBottomRight = new Property("");
      _isVideo = new Property(false);
      _isAudio = new Property(false);
