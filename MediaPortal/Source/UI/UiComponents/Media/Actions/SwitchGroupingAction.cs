...
{
  public class SwitchGroupingAction : IWorkflowContributor
  {
    ...
    {
      get { return LocalizationHelper.CreateResourceString(Consts.RES_SWITCH_GROUPING); }
    }
    ...
    public void Execute()
    {
      ...
      screenManager.ShowDialog(Consts.DIALOG_SWITCH_GROUPING);
    }
