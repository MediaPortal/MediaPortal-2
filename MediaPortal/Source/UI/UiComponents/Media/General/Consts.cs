...
namespace MediaPortal.UiComponents.Media.General
{
  public class Consts
  {
    ...
    public const string STR_WF_STATE_ID_FAVORITE_MEDIA = "17243BF9-5B84-4563-9A41-7E607C12887D";
    ...
    public static readonly Guid WF_STATE_ID_FAVORITE_MEDIA = new Guid(STR_WF_STATE_ID_FAVORITE_MEDIA);
    ...
    public const string RES_FAVORITE_MEDIA_MENU_ITEM = "[Media.FavoriteMediaMenuItem]";
