...
INSERT INTO USER_MEDIA_ITEM_DATA SELECT * FROM USER_MEDIA_ITEM_DATA%SUFFIX% WHERE PROFILE_ID IN (SELECT PROFILE_ID FROM USER_PROFILES) AND MEDIA_ITEM_ID IN (SELECT MEDIA_ITEM_ID FROM MEDIA_ITEMS);
