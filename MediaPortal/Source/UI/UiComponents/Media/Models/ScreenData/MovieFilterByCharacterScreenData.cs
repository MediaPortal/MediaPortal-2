...
{
  public class MovieFilterByCharacterScreenData : AbstractVideosFilterScreenData
  {
    public MovieFilterByCharacterScreenData() :
        ...
        Consts.RES_FILTER_ACTOR_NAVBAR_DISPLAY_LABEL, new FilterByMovieCharacterCriterion())
    {
    }
