...
namespace TagLib.WavPack
{
   ...
   public class File : TagLib.NonContainer.File
   {
      ...
      public File (IFileAbstraction fileAbstraction, ReadStyle properties_style) : base (fileAbstraction, properties_style)
      {}
      ...
      // Added by Albert/MediaPortal
      public File (IFileAbstraction fileAbstraction) : this (fileAbstraction, ReadStyle.Average)
      {}
