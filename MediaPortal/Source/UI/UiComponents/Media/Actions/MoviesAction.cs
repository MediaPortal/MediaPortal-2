...
{
  public class MoviesAction : VisibilityDependsOnServerConnectStateAction
  {
    #region Consts
    ...
    public const string RES_MOVIES_MENU_ITEM = "[Media.MoviesMenuItem]";

    #endregion

    public MoviesAction() :
      base(true, Consts.WF_STATE_ID_MOVIES_NAVIGATION_ROOT, RES_MOVIES_MENU_ITEM) { }
  }
}