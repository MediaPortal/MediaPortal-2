...
namespace MediaPortal.Backend.Services.MediaLibrary.QueryEngine
{
  public class CompiledFilter
  {
        ...
        IList<object> resultParts, IList<BindVar> resultBindVars)
    {
      ...
      CertificationAgeFilter certificationAgeFilter = filter as CertificationAgeFilter;
      if(certificationAgeFilter != null)
      {
        if (certificationAgeFilter.RequiredMinimumAge < CertificationMapper.MAX_AGE && certificationAgeFilter.RequiredMinimumAge >= 0)
        {
          ...
          if (_requiredMIATypes.Contains(EpisodeAspect.Metadata) && certs != null)
          {
            ...
            sqlStatement.Append(MIA_Management.MIA_MEDIA_ITEM_ID_COL_NAME);
            sqlStatement.Append(" FROM ");
            sqlStatement.Append(miaManagement.GetMIATableName(MovieAspect.Metadata));
            ...
            resultParts.Add(" IN(");
            resultParts.Add(sqlStatement.ToString());
            resultParts.Add(")");
          ...
          else if (certs != null)
          {
            ...
            resultParts.Add(MIA_Management.MIA_MEDIA_ITEM_ID_COL_NAME);
            resultParts.Add(" FROM ");
            resultParts.Add(miaManagement.GetMIATableName(MovieAspect.Metadata));
            resultParts.Add(" WHERE ");
