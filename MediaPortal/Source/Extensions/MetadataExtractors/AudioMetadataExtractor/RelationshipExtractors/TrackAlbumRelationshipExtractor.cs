...
{
  class TrackAlbumRelationshipExtractor : IRelationshipRoleExtractor, IAudioRelationshipExtractor
  {
    ...
    private static readonly string[] RELATIONSHIP_SEARCH_PRIORITY = { ExternalIdentifierAspect.TYPE_ALBUM };
