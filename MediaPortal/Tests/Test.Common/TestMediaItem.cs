...
namespace Test.Common
{
  ...
  public class TestMediaItem
  {
    ...
    private void AddRelationship(IDictionary<Guid, IList<MediaItemAspect>> aspects, Guid localRole, Guid remoteRole, Guid remoteId)
    {
      MultipleMediaItemAspect relationship = new MultipleMediaItemAspect(RelationshipAspect.Metadata);
