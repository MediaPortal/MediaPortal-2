...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.WSS.json.Control
{
  ...
  {
    public static async Task<WebStringResult> ProcessAsync(RequestContext context, string identifier, string profileName, long startPosition, int audioId = -1, int subtitleId = -1)
    {
      if (identifier == null)
