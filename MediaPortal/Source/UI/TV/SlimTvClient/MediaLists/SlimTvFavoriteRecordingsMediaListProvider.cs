...
{
  public class SlimTvFavoriteRecordingsMediaListProvider : BaseFavoriteMediaListProvider
  {
  ...
  public class SlimTvFavoriteTVRecordingsMediaListProvider : SlimTvFavoriteRecordingsMediaListProvider
  {
    public SlimTvFavoriteTVRecordingsMediaListProvider()
    {
      _necessaryMias = _necessaryMias.Union(new[] { VideoAspect.ASPECT_ID });
    }
  }

  public class SlimTvFavoriteRadioRecordingsMediaListProvider : SlimTvFavoriteRecordingsMediaListProvider
  {
