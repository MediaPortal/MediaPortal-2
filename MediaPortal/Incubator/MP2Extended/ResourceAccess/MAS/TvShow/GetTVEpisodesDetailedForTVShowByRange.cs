...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.TvShow
{
  ...
  {
    public static async Task<IList<WebTVEpisodeDetailed>> ProcessAsync(RequestContext context, string id, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
