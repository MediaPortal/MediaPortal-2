...
{
  class MovieProductionRelationshipExtractor : IRelationshipRoleExtractor, IMovieRelationshipExtractor
  {
    ...
    public MovieProductionRelationshipExtractor()
    {
      _includeDetails = ServiceRegistration.Get<ISettingsManager>().Load<MovieMetadataExtractorSettings>().IncludeProductionCompanyDetails;
    }
