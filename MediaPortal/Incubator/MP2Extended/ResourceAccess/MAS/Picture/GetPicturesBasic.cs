...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Picture
{
  ...
  internal class GetPicturesBasic : BasePictureBasic
  {
    public static Task<IList<WebPictureBasic>> ProcessAsync(RequestContext context, string filter, WebSortField? sort, WebSortOrder? order)
    {
      ...
      return System.Threading.Tasks.Task.FromResult<IList<WebPictureBasic>>(output);
    }
