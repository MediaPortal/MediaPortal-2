...
{
  public class ProgressBuilder : BuilderHelper, IControlBuilder
  {
    /// <summary>
                                ...
                                Control parent)
    {
      ...
      Progress image = new Progress(parent);
