...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.TAS.Schedule
{
  ...
  {
    public static async Task<WebBoolResult> ProcessAsync(RequestContext context, string channelId, string title, DateTime startTime, DateTime endTime, WebScheduleType scheduleType, int preRecordInterval, int postRecordInterval, string directory, int priority)
    {
