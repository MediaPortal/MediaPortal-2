  ...
  public class SlimTvPlayerBuilder : IPlayerBuilder
  {
    ...
    public IPlayer GetPlayer(MediaItem mediaItem)
    {
      ...
      if (!mediaItem.GetPlayData(out mimeType, out title))
        return null;
      if (mimeType != LiveTvMediaItem.MIME_TYPE_TV && mimeType != LiveTvMediaItem.MIME_TYPE_RADIO && mimeType != LiveTvMediaItem.MIME_TYPE_WTVREC && mimeType != LiveTvMediaItem.MIME_TYPE_TV_STREAM)
        return null;
