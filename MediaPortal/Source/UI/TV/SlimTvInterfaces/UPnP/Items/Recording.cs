...
{
  public class Recording : IRecordingSeries
  {
    private static XmlSerializer _xmlSerializer;

    #region IRecording Member
    ...
    /// <summary>
    /// Serializes this Recording instance to the given <paramref name="writer"/>.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a Recording instance from a given XML fragment.
    /// </summary>
    ...
    public static Recording Deserialize(string str)
    {
      ...
      using (StringReader reader = new StringReader(str))
        return xs.Deserialize(reader) as Recording;
    }

    /// <summary>
    /// Deserializes a Recording instance from a given <paramref name="reader"/>.
    /// </summary>
    /// <param name="reader">XML reader containing a serialized user profile instance.</param>
    /// <returns>Deserialized instance.</returns>
    public static Recording Deserialize(XmlReader reader)
    {
      XmlSerializer xs = GetOrCreateXMLSerializer();
      return xs.Deserialize(reader) as Recording;
    }
    ...
    {
      return _xmlSerializer ?? (_xmlSerializer = new XmlSerializer(typeof(Recording)));
    }
  }
}
