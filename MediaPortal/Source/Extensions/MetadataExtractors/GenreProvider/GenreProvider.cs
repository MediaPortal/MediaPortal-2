  ...
  public class GenreProvider : IGenreProvider
  {
    ...
    private void InitMusicGenre(string language)
    {
      ...
      list.AddRange(new GenreMapping[]
      {
        ...
        new GenreMapping((int)AudioGenre.Country, new Regex(GenreStringManager.TryGetGenreString("Match", "Audio.Country", language, out genreRegex) ? genreRegex : @"Country", RegexOptions.IgnoreCase)),
        ...
        new GenreMapping((int)AudioGenre.Soul, new Regex(GenreStringManager.TryGetGenreString("Match", "Audio.Soul", language, out genreRegex) ? genreRegex : @"Soul", RegexOptions.IgnoreCase)),
        new GenreMapping((int)AudioGenre.Rap, new Regex(GenreStringManager.TryGetGenreString("Match", "Audio.Rap", language, out genreRegex) ? genreRegex : @"Rap", RegexOptions.IgnoreCase)),
