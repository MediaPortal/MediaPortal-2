...
{
  public class EnableMenuSelectionConfiguration : YesNo, IDisposable
  {
    public EnableMenuSelectionConfiguration()
    {
    ...
    {
      base.Load();
      _yes = SettingsManager.Load<NereusSkinSettings>().EnableMenuSelection;
    }
    ...
    public override void Save()
    {
      ...
      settings.EnableMenuSelection = _yes;
