...
{
  public class HardcodedSubtitlesAllowedSetting : YesNo, IDisposable
  {
    public HardcodedSubtitlesAllowedSetting()
    {
      Enabled = false;
    ...
    public override void Load()
    {
      ...
      Yes = settings.HardcodedSubtitlesAllowed;
    }
    ...
    public override void Save()
    {
      ...
      IServerSettingsClient serverSettings = ServiceRegistration.Get<IServerSettingsClient>();
      MediaServerSettings settings = serverSettings.Load<MediaServerSettings>();
      settings.HardcodedSubtitlesAllowed = Yes;
