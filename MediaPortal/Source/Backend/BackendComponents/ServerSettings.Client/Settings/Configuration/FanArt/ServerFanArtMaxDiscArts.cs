...
{
  public class ServerFanArtMaxDiscArts : LimitedNumberSelect, IDisposable
  {
    public ServerFanArtMaxDiscArts()
    {
      Enabled = false;
    ...
    public override async Task Load()
    {
      ...
      _value = (await serverSettings.LoadAsync<FanArtSettings>()).MaxDiscArt;
    }
    ...
    public override async Task Save()
    {
      ...
      settings.MaxDiscArt = Convert.ToInt32(_value);
