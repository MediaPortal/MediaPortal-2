  ...
  public class TestReconciler
  {
    ...
    public void TestReconcileMediaItem()
    {
      ...
      MockReader reader2 = MockDBUtils.AddReader(2,
        "SELECT T6.MEDIA_ITEM_ID A31, T0.MEDIA_ITEM_ID A32, T1.MEDIA_ITEM_ID A33, T2.MEDIA_ITEM_ID A34, T3.MEDIA_ITEM_ID A35, T4.MEDIA_ITEM_ID A36, T5.MEDIA_ITEM_ID A37, " +
        ...
        "T3.SYSTEM_ID A16, T3.RESOURCEID A17, T3.MIMETYPE A18, T3.SIZE A19, T3.PATH A20, T3.PARENTDIRECTORY A21, " +
        "T4.SERIESNAME_0 A22, T4.SEASON_0 A23, T4.SERIESSEASONNAME_0 A24, T4.DESCRIPTION A25, T4.FIRSTAIRED_0 A26, T4.TOTALRATING_0 A27, T4.RATINGCOUNT_0 A28, " +
        "T5.SERIESNAME_1 A29, T5.DESCRIPTION_0 A30 " +
        "FROM MEDIA_ITEMS T6 " +
      ...
      reader2.AddResult(
        ...
        systemId, null, mimeType, 100, @"c:\", parentDirectoryId,
      ...
      MockDBUtils.AddReader(6,
        ...
        "T0.ROLE A0, T0.LINKEDROLE A1, T0.LINKEDID A2, T0.LINKEDINDEX A3 " +
        "FROM M_RELATIONSHIP T0  " +
        "WHERE T0.MEDIA_ITEM_ID = @V0",
        CreateAttributeIdList(3, 4));

      MockDBUtils.AddReader(7,
        "SELECT T0.MEDIA_ITEM_ID A4, T0.MEDIA_ITEM_ID A5, T0.ROLE A0, T0.LINKEDROLE A1, T0.LINKEDID A2, T0.LINKEDINDEX A3 FROM M_RELATIONSHIP T0  WHERE T0.LINKEDID IN (@V0)");

      // Readers used by UpdateRelationships to find season item

      MockDBUtils.AddReader(8,
        "SELECT T0.MEDIA_ITEM_ID A31, T0.MEDIA_ITEM_ID A32, T1.MEDIA_ITEM_ID A33, T2.MEDIA_ITEM_ID A34, T3.MEDIA_ITEM_ID A35, T4.MEDIA_ITEM_ID A36, T5.MEDIA_ITEM_ID A37, " +
        ...
        "T4.SYSTEM_ID A23, T4.RESOURCEID A24, T4.MIMETYPE A25, T4.SIZE A26, T4.PATH A27, T4.PARENTDIRECTORY A28, " +
        "T5.SERIESNAME_1 A29, T5.DESCRIPTION_0 A30 " +
      ...
      reader10.AddResult(
        ...
        null, null, null, 0, null, Guid.Empty,
      ...
      MockDBUtils.AddReader(14,
        ...
        "T4.SYSTEM_ID A18, T4.RESOURCEID A19, T4.MIMETYPE A20, T4.SIZE A21, T4.PATH A22, T4.PARENTDIRECTORY A23, " +
        "T5.SERIESNAME_0 A24, T5.SEASON_0 A25, T5.SERIESSEASONNAME_0 A26, T5.DESCRIPTION A27, T5.FIRSTAIRED_0 A28, T5.TOTALRATING_0 A29, T5.RATINGCOUNT_0 A30 " +
