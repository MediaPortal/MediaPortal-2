...
namespace Models.Music
{
  ...
  internal class MusicComparer : IComparer<ListItem>
  {
    ...
    public MusicComparer(int option, IMetaDataMappingCollection mapping)
    {
      _sortOption = option;
    ...
    public int Compare(ListItem x, ListItem y)
    {
      ...
      object obj1 = null;
      object obj2 = null;
      MusicItem movie1 = x as MusicItem;
      MusicItem movie2 = y as MusicItem;
