...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.TvShow
{
  ...
  {
    public static Task<IList<WebTVSeasonDetailed>> ProcessAsync(RequestContext context, string id, WebSortField? sort, WebSortOrder? order)
    {
      ...
      if (seasons.Count == 0)
        return Task.FromResult<IList<WebTVSeasonDetailed>>(new List<WebTVSeasonDetailed>());
