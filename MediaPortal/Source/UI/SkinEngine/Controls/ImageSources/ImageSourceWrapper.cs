...
namespace MediaPortal.UI.SkinEngine.Controls.ImageSources
{
  ...
  public class ImageSourceWrapper : MultiImageSource
  {
    ...
    public override void Allocate()
    {
      ...
      var lastTexture = _lastTexture;
      var currentTexture = _currentTexture;
      var nextTexture = _nextTexture;
      ...
      if (nextTexture != null)
      {
        if (!_fallbackSourceInUse && nextTexture.LoadFailed)
        {
          ...
          {
            nextTexture = ContentManager.Instance.GetBitmap(uri, DecodePixelWidth, DecodePixelHeight, Thumbnail);
