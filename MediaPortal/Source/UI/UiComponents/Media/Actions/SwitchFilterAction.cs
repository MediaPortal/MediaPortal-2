...
{
  public class SwitchFilterAction : IWorkflowContributor
  {
    ...
    {
      get { return LocalizationHelper.CreateResourceString(Consts.RES_SWITCH_FILTER); }
    }
    ...
    public void Execute()
    {
      ...
      screenManager.ShowDialog(Consts.DIALOG_SWITCH_FILTER);
    }
