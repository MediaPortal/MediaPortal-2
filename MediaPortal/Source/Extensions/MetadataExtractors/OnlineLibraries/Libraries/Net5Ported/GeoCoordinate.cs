  ...
  public class GeoCoordinate : IEquatable<GeoCoordinate>
  {
    ...
    public Double Latitude
    {
      ...
      set
      {
        ...
        {
          throw new ArgumentOutOfRangeException("Latitude", String.Format("Argument_MustBeInRangeNegative90to90"));
        }
        m_latitude = value;
      }
    }
    ...
    public Double Longitude
    {
      ...
      set
      {
        ...
        {
          throw new ArgumentOutOfRangeException("Longitude", String.Format("Argument_MustBeInRangeNegative180To180"));
        }
        m_longitude = value;
      }
    }
    ...
    public Double HorizontalAccuracy
    {
      ...
      set
      {
        if (value < 0.0)
        {
          throw new ArgumentOutOfRangeException("HorizontalAccuracy", String.Format("Argument_MustBeNonNegative"));
        }
    ...
    public Double VerticalAccuracy
    {
      ...
      set
      {
        if (value < 0.0)
        {
          throw new ArgumentOutOfRangeException("VerticalAccuracy", String.Format("Argument_MustBeNonNegative"));
        }
    ...
    public Double Speed
    {
      ...
      set
      {
        if (value < 0.0)
        {
          throw new ArgumentOutOfRangeException("speed", String.Format("Argument_MustBeNonNegative"));
        }
        m_speed = value;
      }
    }
    ...
    public Double Course
    {
      ...
      set
      {
        ...
        {
          throw new ArgumentOutOfRangeException("course", String.Format("Argument_MustBeInRangeZeroTo360"));
        }
        m_course = value;
      }
    }
    ...
    public Double GetDistanceTo(GeoCoordinate other)
    {
      ...
      {
        throw new ArgumentException(String.Format("Argument_LatitudeOrLongitudeIsNotANumber"));
      }
