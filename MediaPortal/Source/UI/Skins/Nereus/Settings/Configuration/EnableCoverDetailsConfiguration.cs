...
{
  public class EnableCoverDetailsConfiguration : YesNo, IDisposable
  {
    public EnableCoverDetailsConfiguration()
    {
    ...
    {
      base.Load();
      _yes = SettingsManager.Load<NereusSkinSettings>().EnableCoverDetails;
    }
    ...
    public override void Save()
    {
      ...
      settings.EnableCoverDetails = _yes;
