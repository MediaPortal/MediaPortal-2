...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.TAS.Schedule
{
  ...
  {
    public static async Task<IList<WebScheduleBasic>> ProcessAsync(RequestContext context, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
