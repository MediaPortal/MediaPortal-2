...
namespace MediaPortal.UiComponents.BackgroundManager.Helper
{
  ...
  /// </summary>
  public static class BackgroundManagerMessaging
  {
    // Message channel name
    public const string CHANNEL = "BackgroundManagerMessages";

    // Message type
    public enum MessageType
    {
      /// <summary>
      /// This message will be sent when the settings has been changed.
      /// </summary>
      SettingsChanged,
    }
