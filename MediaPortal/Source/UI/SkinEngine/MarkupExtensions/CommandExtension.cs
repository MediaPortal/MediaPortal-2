...
namespace MediaPortal.UI.SkinEngine.MarkupExtensions
{
  ...
  /// </summary>
  public class CommandExtension : CommandBaseMarkupExtension, IExecutableCommand
  {
    ...
    public CommandExtension(string path): base(path)
    { }

    public override void DeepCopy(IDeepCopyable source, ICopyManager copyManager)
    {
      base.DeepCopy(source, copyManager);
      CommandExtension cme = (CommandExtension) source;
