...
{
  [DebuggerDisplay("Images({Images.Count})")]
  partial class ImagesModel : ICheckable
  {
    ...
    {
      return Images.Aggregate(true, (current, model) => current && model.CheckElements(log));
    }
