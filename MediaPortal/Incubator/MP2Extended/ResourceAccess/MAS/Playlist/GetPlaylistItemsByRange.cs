...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Playlist
{
  ...
  {
    public static async Task<IList<WebPlaylistItem>> ProcessAsync(HttpContext context, string playlistId, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
