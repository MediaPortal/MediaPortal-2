  ...
  public abstract class SeriesMatcher<TImg, TLang> : BaseMatcher<SeriesMatch, string>
  {
    ...
    public virtual bool UpdateSeriesCharacters(SeriesInfo seriesInfo, bool forceQuickMode)
    {
      try
      {
        ...
        foreach (CharacterInfo character in seriesInfo.Characters)
        {
          ...
          {
            thumbs = GetFanArtFiles(character, FanArtScope.Character, FanArtType.Thumbnails);
            if (thumbs.Count > 0)
    ...
    protected override void DownloadFanArt(string downloadId)
    {
      try
      {
        ...
        TLang language = FindBestMatchingLanguage(seriesInfo);
        FanArtImageCollection<TImg> images;
        string scope = FanArtScope.Movie;
        ...
        if(images != null)
        {
          ...
          SaveFanArtImages(images.Id, images.Backdrops, scope, FanArtType.Backdrops);
          SaveFanArtImages(images.Id, images.Posters, scope, FanArtType.Posters);
          SaveFanArtImages(images.Id, images.Banners, scope, FanArtType.Banners);
          SaveFanArtImages(images.Id, images.ClearArt, scope, FanArtType.ClearArt);
          SaveFanArtImages(images.Id, images.Covers, scope, FanArtType.Covers);
          SaveFanArtImages(images.Id, images.DiscArt, scope, FanArtType.DiscArt);
          SaveFanArtImages(images.Id, images.Logos, scope, FanArtType.Logos);
          SaveFanArtImages(images.Id, images.Thumbnails, scope, FanArtType.Thumbnails);
        }

        if (seasonNo > 0)
        {
          scope = FanArtScope.Season;
          ...
          if (images != null)
          {
            ...
            {
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Backdrops, scope, FanArtType.Backdrops);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Posters, scope, FanArtType.Posters);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Banners, scope, FanArtType.Banners);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.ClearArt, scope, FanArtType.ClearArt);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Covers, scope, FanArtType.Covers);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.DiscArt, scope, FanArtType.DiscArt);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Logos, scope, FanArtType.Logos);
              SaveSeriesSeasonFanArtImages(seriesId, seasonNo, images.Thumbnails, scope, FanArtType.Thumbnails);
            }
          }
        }
        ...
        if (episodeInfo != null)
        {
          ...
          if (images != null)
          {
            ...
            {
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Backdrops, scope, FanArtType.Backdrops);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Posters, scope, FanArtType.Posters);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Banners, scope, FanArtType.Banners);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.ClearArt, scope, FanArtType.ClearArt);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Covers, scope, FanArtType.Covers);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.DiscArt, scope, FanArtType.DiscArt);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Logos, scope, FanArtType.Logos);
              SaveSeriesEpisodeFanArtImages(seriesId, seasonNo, episodeNo, images.Thumbnails, scope, FanArtType.Thumbnails);
            }
          }
        }

        scope = FanArtScope.Actor;
