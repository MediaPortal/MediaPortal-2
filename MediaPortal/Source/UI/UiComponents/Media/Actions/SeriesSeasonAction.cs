...
{
  public class SeriesSeasonAction : VisibilityDependsOnServerConnectStateAction
  {
    #region Consts
    ...
    public SeriesSeasonAction() :
        base(true, Consts.WF_STATE_ID_SERIES_NAVIGATION_ROOT, Consts.RES_SERIES_SEASON_MENU_ITEM) { }
  }
}