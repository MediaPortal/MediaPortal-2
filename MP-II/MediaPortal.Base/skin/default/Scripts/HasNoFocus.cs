...
public class Scriptlet : IScriptProperty
{
  public Property Get(IControl control, string param)
  {
    ...
    if (c == null)
      return new Property("HasNoFocus.ControlIsNull", true);
    if (c.IsFocusable == false)
      return Get(c.Container, param);
    if ((c as ListContainer) != null)
      return new Property("HasNoFocus.ControlIsList", true);
    return new BooleanProperty(c.HasFocusProperty);
  }
}
