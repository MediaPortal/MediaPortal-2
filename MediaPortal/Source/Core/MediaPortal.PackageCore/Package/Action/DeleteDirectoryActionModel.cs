...
{
  [DebuggerDisplay("DeleteDirectory({Target}, SkipInFotEmpty={SkipInFotEmpty}, FailIfNotExists={FailIfNotExists})")]
  partial class DeleteDirectoryActionModel
  {
    #region Overrides of ActionBaseModel

    public override string ElementsName
    {
      get { return "DeleteDirectory"; }
    }
    ...
    {
      FileHelper.DeleteDirectory(context, 
        context.GetPath(Target), 
        SkipInFotEmpty, FailIfNotExists, true);
    }
