...
{
  public class SeriesFilterByYearScreenData : AbstractSeriesFilterScreenData<FilterItem>
  {
    public SeriesFilterByYearScreenData() :
        base(Consts.SCREEN_SERIES_FILTER_BY_YEAR, Consts.RES_COMMON_BY_YEAR_MENU_ITEM,
    ...
    {
      return new SeriesFilterByYearScreenData();
    }
  }
}
