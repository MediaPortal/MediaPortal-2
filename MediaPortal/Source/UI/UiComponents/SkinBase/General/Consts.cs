...
namespace MediaPortal.UiComponents.SkinBase.General
{
  public class Consts
  {
    ...
    public const string STR_WF_STATE_ID_SHARE_ADD_RESOURCE_PROVIDER = "7DDE6ADF-7EA2-4376-A2A2-94459490B207";
    public static readonly Guid WF_STATE_ID_SHARE_ADD_CHOOSE_RESOURCE_PROVIDER = new Guid(STR_WF_STATE_ID_SHARE_ADD_RESOURCE_PROVIDER);
