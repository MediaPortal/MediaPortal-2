...
{
  public class ServerFanArtMaxClearArts : LimitedNumberSelect, IDisposable
  {
    public ServerFanArtMaxClearArts()
    {
      Enabled = false;
    ...
    public override async Task Load()
    {
      ...
      _value = (await serverSettings.LoadAsync<FanArtSettings>()).MaxClearArt;
    }
    ...
    public override async Task Save()
    {
      ...
      settings.MaxClearArt = Convert.ToInt32(_value);
