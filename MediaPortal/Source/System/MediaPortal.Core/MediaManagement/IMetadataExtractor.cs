...
namespace MediaPortal.Core.MediaManagement
{
  ...
  public interface IMetadataExtractor
  {
    ...
    /// <param name="forceQuickMode">Interactive browsing needs to be quick, but the server side importer can extract further details. If the value is set to <c>true</c>, no slow operations are permitted (like non-cached thumbnail extraction).</param>
