...
//        new List<string>(new string[] { ".wmv", ".avi", ".mkv", ".dvr-ms", ".ts", ".mpg"});
...
//        {
//          return false;
//          //return CreateThumb(filePath, 0.05, thumbDb);
...
//    //private static bool CreateThumb(string videoFilename, double positionPercent, ThumbDatabase thumbDb)
//    //{
//    //  ServiceRegistration.Get<ILogger>().Info("Creating thumb for {0}", videoFilename);
//    //  bool rval = false;
...
//    //  {
//    //    m.get_StreamMediaType(mediaType);
...
//    //        thumbDb.Add(videoFilename, ImageType.Jpeg, stream);
//    //        stream.Close();
//    //      }
...
//    //private static void Workaround(MediaPlayer mp)
//    //{
//    //  mp.Play();
//    //  int maxSleep = 10;
//    //  TimeSpan startPosition = mp.Position;
//    //  while (startPosition == mp.Position && maxSleep-- > 0)
//    //  {
//    //   Thread.Sleep(1000);
//    //  }
//    //  mp.Pause();
