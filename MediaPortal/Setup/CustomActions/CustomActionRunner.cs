...
namespace CustomActions
{
  public class CustomActionRunner
  {
    ...
    private const string LAV_FILTERS_URL = "http://install.team-mediaportal.com/MP2/install/LAVFilters-0.74.1.exe";
    private const string LAV_FILTERS_METADATA_FILE = "http://install.team-mediaportal.com/MP2/install/metadata/LAVFilters-0741.xml";
