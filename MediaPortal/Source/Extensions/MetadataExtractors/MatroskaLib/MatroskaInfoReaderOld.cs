...
{
  /// <summary>
  /// <see cref="MatroskaInfoReaderOld"/> uses the mkvtoolnix utilities to extract metadata and attachments from matroska files.
  /// </summary>
  public class MatroskaInfoReaderOld
  {
    ...
    /// <summary>
    /// Constructs a new <see cref="MatroskaInfoReaderOld"/>.
    /// </summary>
    /// <param name="lfsra">
    ...
    /// </param>
    public MatroskaInfoReaderOld(ILocalFsResourceAccessor lfsra)
    {
      _lfsra = lfsra;
