...
// Copyright (C) 2005-2007 Brian Nickel (Original Implementation as TextIdentificationFrame)
...
namespace TagLib.Id3v2
{
  ...
  public class UrlLinkFrame : Frame
  {
    ...
    /// <summary>
    ///    Constructs and initializes a new instance of <see
    ///    cref="UrlLinkFrame" /> by reading its raw
  ...
  public class UserUrlLinkFrame : UrlLinkFrame
  {
    ...
    /// <summary>
    ///    Constructs and initializes a new instance of <see
    ///    cref="UserUrlLinkFrame" /> with a specified
    ...
    /// <summary>
    ///    Constructs and initializes a new instance of <see
    ///    cref="UserUrlLinkFrame" /> by reading its raw
