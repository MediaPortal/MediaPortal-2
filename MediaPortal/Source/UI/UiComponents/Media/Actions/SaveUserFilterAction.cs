...
{
  public class SaveUserFilterAction : IWorkflowContributor
  {
    ...
    {
      get { return LocalizationHelper.CreateResourceString(Consts.RES_SAVE_USER_FILTER); }
    }
    ...
    public bool IsActionVisible(NavigationContext context)
    {
      ...
      return navigationData != null && navigationData.GetWorkflowActions().Count > 0;
    }
    ...
    public void Execute()
    {
      ...
      screenManager.ShowDialog(Consts.DIALOG_SAVE_USER_FILTER);
    }
