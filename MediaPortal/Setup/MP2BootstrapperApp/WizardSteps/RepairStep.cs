...
namespace MP2BootstrapperApp.WizardSteps
{
  public class RepairStep : AbstractInstallStep, IStep
  {
    ...
    public IStep Next()
    {
      ...
      IEnumerable<string> installedFeatures = _bootstrapperApplicationModel.MainPackage.Features.Where(f => !f.Attributes.HasFlag(FeatureAttributes.UIDisallowAbsent) && f.CurrentFeatureState == FeatureState.Local).Select(f => f.Id);
