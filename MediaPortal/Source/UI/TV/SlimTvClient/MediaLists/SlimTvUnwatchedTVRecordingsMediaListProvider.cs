...
{
  public class SlimTvUnwatchedTVRecordingsMediaListProvider : BaseUnwatchedMediaListProvider
  {
    public SlimTvUnwatchedTVRecordingsMediaListProvider()
    {
      _changeAspectIds = new[] { RecordingAspect.ASPECT_ID, VideoAspect.ASPECT_ID };
