  ...
  public class WizardStepViewModelBuilder
  {
    ...
    void LoadViewModelTypes()
    {
      _wizardStepToViewModelMap = Assembly.GetExecutingAssembly().GetTypes()
        ...
        .Where(t => typeof(IPageViewModel).IsAssignableFrom(t) && !t.IsAbstract)
    ...
    public IPageViewModel GetViewModel(IStep step)
    {
      if (step == null)
      ...
      return Activator.CreateInstance(viewModelType, step) as IPageViewModel;
    }
  }
}
