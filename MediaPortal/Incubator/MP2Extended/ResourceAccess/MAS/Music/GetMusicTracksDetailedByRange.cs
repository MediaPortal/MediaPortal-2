...
namespace MediaPortal.Plugins.MP2Extended.ResourceAccess.MAS.Music
{
  ...
  {
    public static async Task<IList<WebMusicTrackDetailed>> ProcessAsync(HttpContext context, int start, int end, string filter, WebSortField? sort, WebSortOrder? order)
    {
