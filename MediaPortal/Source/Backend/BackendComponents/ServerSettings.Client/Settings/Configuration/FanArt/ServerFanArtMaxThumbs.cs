...
{
  public class ServerFanArtMaxThumbs : LimitedNumberSelect, IDisposable
  {
    public ServerFanArtMaxThumbs()
    {
      Enabled = false;
    ...
    public override async Task Load()
    {
      ...
      _value = (await serverSettings.LoadAsync<FanArtSettings>()).MaxThumbFanArt;
    }
    ...
    public override async Task Save()
    {
      ...
      settings.MaxThumbFanArt = Convert.ToInt32(_value);
