...
namespace Models.Pictures
{
  ...
  internal class PictureComparer : IComparer<ListItem>
  {
    ...
    public PictureComparer(int option, IMetaDataMappingCollection mapping)
    {
      _sortOption = option;
    ...
    public int Compare(ListItem x, ListItem y)
    {
      ...
      object obj1 = null;
      object obj2 = null;
      PictureItem movie1 = x as PictureItem;
      PictureItem movie2 = y as PictureItem;
