...
{
  public class MovieFilterByActorScreenData : AbstractMovieFilterScreenData<ActorFilterItem>
  {
    public MovieFilterByActorScreenData() :
      base(Consts.SCREEN_MOVIES_FILTER_BY_ACTOR, Consts.RES_COMMON_BY_ACTOR_MENU_ITEM,
        Consts.RES_FILTER_ACTOR_NAVBAR_DISPLAY_LABEL, new FilterByActorCriterion(MovieAspect.ROLE_MOVIE))
    {
