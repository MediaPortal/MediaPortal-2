...
Because of this, this project is not included in the main MediaPortal solution. Instead the Media.Players.BassPlayer refers a prebuild dll in this project's "Distrib" folder and copies that into the main MediaPortal outputdir on build. This way the main MediaPortal solution can still be build without the ASIO SDK.
