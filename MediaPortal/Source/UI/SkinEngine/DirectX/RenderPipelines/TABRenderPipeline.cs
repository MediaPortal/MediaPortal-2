...
namespace MediaPortal.UI.SkinEngine.DirectX.RenderPipelines
{
  ...
  internal class TABRenderPipeline : AbstractMultiPassRenderPipeline
  {
    ...
    {
      _firstFrameTargetRect = new RawRectangleF(0, 0, _backbuffer.PixelSize.Width, _backbuffer.PixelSize.Height / 2);
      _secondFrameTargetRect = new RawRectangleF(0, _backbuffer.PixelSize.Height / 2, _backbuffer.PixelSize.Width, _backbuffer.PixelSize.Height / 2);
      InitMasks();
    }
