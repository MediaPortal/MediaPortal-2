...
{
  public class ServerSubtitleLanguage : SingleSelectionList, IDisposable
  {
    #region Variables
    ...
    public override void Load()
    {
      ...
      if (string.IsNullOrEmpty(settings.SubtitleLanguageCulture))
        settings.SubtitleLanguageCulture = "en-US";
      CultureInfo current = new CultureInfo(settings.SubtitleLanguageCulture);
    ...
    public override void Save()
    {
      ...
      IServerSettingsClient serverSettings = ServiceRegistration.Get<IServerSettingsClient>();
      OnlineLibrarySettings settings = serverSettings.Load<OnlineLibrarySettings>();
      settings.SubtitleLanguageCulture = _cultures[Selected].Name;
