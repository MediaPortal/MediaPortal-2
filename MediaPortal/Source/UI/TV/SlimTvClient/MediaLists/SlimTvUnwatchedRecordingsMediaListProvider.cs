...
namespace MediaPortal.Plugins.SlimTv.Client.MediaLists
{
  ...
  public class SlimTvUnwatchedTVRecordingsMediaListProvider : SlimTvUnwatchedRecordingsMediaListProvider
  {
    public SlimTvUnwatchedTVRecordingsMediaListProvider()
    {
      _necessaryMias = _necessaryMias.Union(new[] { VideoAspect.ASPECT_ID });
    }
  }

  public class SlimTvUnwatchedRadioRecordingsMediaListProvider : SlimTvUnwatchedRecordingsMediaListProvider
  {
    public SlimTvUnwatchedRadioRecordingsMediaListProvider()
    {
