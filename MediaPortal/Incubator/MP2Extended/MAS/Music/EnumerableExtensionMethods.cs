...
namespace MediaPortal.Plugins.MP2Extended.MAS.Music
{
  ...
  {
    public static IEnumerable<T> SortWebMusicAlbumBasic<T>(this IEnumerable<T> list, WebSortField? sortInput, WebSortOrder? orderInput) where T : WebMusicAlbumBasic
    {
      switch (sortInput)
      {
    ...
    public static IEnumerable<T> SortWebMusicArtistBasic<T>(this IEnumerable<T> list, WebSortField? sortInput, WebSortOrder? orderInput) where T : WebMusicArtistBasic
    {
      switch (sortInput)
      {
        case WebSortField.Title:
