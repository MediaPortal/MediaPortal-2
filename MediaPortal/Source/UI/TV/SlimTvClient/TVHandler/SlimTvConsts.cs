...
namespace MediaPortal.Plugins.SlimTv.Client.TvHandler
{
  public class SlimTvConsts
  {
    ...
    public static Guid WF_TV_MINI_GUIDE_STATE = new Guid("CEBD6D55-6241-4F52-AE0A-84D9421AF7F7");
    ...
    public static Guid WF_RADIO_MINI_GUIDE_STATE = new Guid("33C4FB78-223E-4E87-8A87-EC5968601357");
