...
namespace MediaPortal.UI.SkinEngine.MarkupExtensions
{
  ...
  /// instance will be done by class <see cref="BindingExtension"/>.
  /// </summary>
  public class RelativeSourceExtension : ISkinEngineManagedObject
  {
    //public static RelativeSource PreviousData = new RelativeSource(RelativeSourceMode.PreviousData);
    public static RelativeSourceExtension TemplatedParent = new RelativeSourceExtension(RelativeSourceMode.TemplatedParent);
    public static RelativeSourceExtension Self = new RelativeSourceExtension(RelativeSourceMode.Self);
