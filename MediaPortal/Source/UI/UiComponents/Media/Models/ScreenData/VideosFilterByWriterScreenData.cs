...
{
  public class VideosFilterByWriterScreenData : AbstractVideosFilterScreenData<SimplePersonFilterItem>
  {
    public VideosFilterByWriterScreenData() :
        base(Consts.SCREEN_VIDEOS_FILTER_BY_WRITER, Consts.RES_COMMON_BY_WRITER_MENU_ITEM,
